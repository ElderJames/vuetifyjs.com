export default {
  ...
  features: [
    {
      ...
      title: '开箱即用的项目脚手架',
      text: 'Vuetify已预先制作了8个vue-cli模板。从简单的HTML到全面的服务端渲染（SSR）项目，都只需几分钟就能创建完毕。'
    },
    {
      img: '/static/doc-images/feature2.svg',
      title: '语义化的Material组件',
      text: '已为你需要在项目中使用的很多专用组件做好准备。一共拥有80多个组件，是一个适用于任何应用的解决方案。'
    },
    {
  ...
  checkFeaturesTitle: '应有尽有的工具',
  checkFeaturesTitleCtd: '去构建令人难以置信的用户界面',
  checkFeatures: [
    '社区聊天支持',
    '动态主题',
    'SSR和PWA支持',
